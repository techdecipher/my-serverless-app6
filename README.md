...
```bash
my-serverless-app6$ make build
my-serverless-app6$ make deploy.guided
```
...
```bash
my-serverless-app6$ make invoke
```
...
```bash
my-serverless-app6$ make run
my-serverless-app6$ curl http://localhost:3000/hello
```
...
```bash
my-serverless-app6$ sam logs -n HelloWorldFunction --stack-name <Name-of-your-deployed-stack> --tail
```
...
```bash
my-serverless-app6$ make dev
my-serverless-app6$ make test
```
...
```bash
my-serverless-app6$ aws cloudformation delete-stack --stack-name my-serverless-app6
```
...
```bash
my-serverless-app6$ pipenv lock -r > hello_world/requirements.txt
```
